...
export default function PeriodTabs({ period, onChange }: { period: Period; onChange: (p: Period) => void }) {
  ...
  return (
    <div className="seg grid grid-cols-3 gap-1 p-1 w-full" role="tablist" aria-label="Period">
      {tabs.map((t) => (
        <button
          key={t.id}
          role="tab"
